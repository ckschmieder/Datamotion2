<?php
/**
 * Template Name: DataMotion Video Archive Template
 */
	...
	<div class="row archive">
		...
		<div class="two_column">
			...
			<?php if (have_posts()): while (have_posts()): the_post(); ?>
				...
				$vid = pods('videos', $post->ID);
				$thumb = get_youtube_thumbnail($vid->field('youtube_url'), 1);
				?>
				...
				<a href="<?php the_permalink(); ?>">
					<img src="<?php echo $thumb; ?>" class="video_thumb alignright">
				</a>
				<?php the_excerpt(); ?>
